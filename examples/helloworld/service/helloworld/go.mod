module github.com/go-orb/envoy/examples/helloworld/service/helloworld

go 1.24

require (
	github.com/go-orb/go-orb v0.4.1
	github.com/go-orb/plugins/cli/urfave v0.1.0
	...
	github.com/go-orb/plugins/server/drpc v0.2.1
	github.com/go-orb/plugins/server/http v0.3.1
	github.com/go-orb/plugins/server/memory v0.1.0
